module.exports = (function () {
  ...
  function Operator() {
    ...
    this.EXCLUDE_ALL = "MN_EXCLUDE_ALL";
    this.EXCLUDE_ANY = "MN_EXCLUDE";
  ...
  function RelativeDateRange() {
    this.FISCAL_HALF_BEFORE_LAST = { dateId: { dateId: "FHBL" } };
    this.FISCAL_HALF_BEFORE_LAST_TO_DATE = { dateId: "FHBLTD" };
    this.FISCAL_QUARTER_BEFORE_LAST = { dateId: "FQBL" };
    this.FISCAL_QUARTER_BEFORE_LAST_TO_DATE = { dateId: "FQBLTD" };
    this.FISCAL_YEAR_BEFORE_LAST = { dateId: "FYBL" };
    this.FISCAL_YEAR_BEFORE_LAST_TO_DATE = { dateId: "FYBLTD" };
    this.FIVE_DAYS_AGO = { dateId: "DAGO5" };
    this.FIVE_DAYS_FROM_NOW = { dateId: "DFN5" };
    this.FOUR_DAYS_AGO = { dateId: "DAGO4" };
    this.FOUR_DAYS_FROM_NOW = { dateId: "DFN4" };
    this.FOUR_WEEKS_STARTING_THIS_WEEK = { dateId: "TWN3W" };
    this.LAST_BUSINESS_WEEK = { dateId: "LBW" };
    this.LAST_FISCAL_HALF = { dateId: "LFH" };
    this.LAST_FISCAL_HALF_ONE_FISCAL_YEAR_AGO = { dateId: "LFHLFY" };
    this.LAST_FISCAL_HALF_TO_DATE = { dateId: "LFHTD" };
    this.LAST_FISCAL_QUARTER = { dateId: "LFQ" };
    this.LAST_FISCAL_QUARTER_ONE_FISCAL_YEAR_AGO = { dateId: "LFQLFY" };
    this.LAST_FISCAL_QUARTER_TO_DATE = { dateId: "LFQTD" };
    this.LAST_FISCAL_QUARTER_TWO_FISCAL_YEARS_AGO = { dateId: "LFQFYBL" };
    this.LAST_FISCAL_YEAR = { dateId: "LFY" };
    this.LAST_FISCAL_YEAR_TO_DATE = { dateId: "LFYTD" };
    this.LAST_MONTH = { dateId: "LM" };
    this.LAST_MONTH_ONE_FISCAL_QUARTER_AGO = { dateId: "LMLFQ" };
    this.LAST_MONTH_ONE_FISCAL_YEAR_AGO = { dateId: "LMLFY" };
    this.LAST_MONTH_TO_DATE = { dateId: "LMTD" };
    this.LAST_MONTH_TWO_FISCAL_QUARTERS_AGO = { dateId: "LMFQBL" };
    this.LAST_MONTH_TWO_FISCAL_YEARS_AGO = { dateId: "LMFYBL" };
    this.LAST_ROLLING_HALF = { dateId: "LRH" };
    this.LAST_ROLLING_QUARTER = { dateId: "LRQ" };
    this.LAST_ROLLING_YEAR = { dateId: "LRY" };
    this.LAST_WEEK = { dateId: "LW" };
    this.LAST_WEEK_TO_DATE = { dateId: "LWTD" };
    this.LAST_YEAR = { dateId: "LY" };
    this.LAST_YEAR_TO_DATE = { dateId: "LYTD" };
    this.MONTH_AFTER_NEXT = { dateId: "MAN" };
    this.MONTH_AFTER_NEXT_TO_DATE = { dateId: "MANTD" };
    this.MONTH_BEFORE_LAST = { dateId: "MBL" };
    this.MONTH_BEFORE_LAST_TO_DATE = { dateId: "MBLTD" };
    this.NEXT_BUSINESS_WEEK = { dateId: "NBW" };
    this.NEXT_FISCAL_HALF = { dateId: "NFH" };
    this.NEXT_FISCAL_QUARTER = { dateId: "NFQ" };
    this.NEXT_FISCAL_YEAR = { dateId: "NFY" };
    this.NEXT_FOUR_WEEKS = { dateId: "N4W" };
    this.NEXT_MONTH = { dateId: "NM" };
    this.NEXT_ONE_HALF = { dateId: "NOH" };
    this.NEXT_ONE_MONTH = { dateId: "NOM" };
    this.NEXT_ONE_QUARTER = { dateId: "NOQ" };
    this.NEXT_ONE_WEEK = { dateId: "NOW" };
    this.NEXT_ONE_YEAR = { dateId: "NOY" };
    this.NEXT_WEEK = { dateId: "NW" };
    this.NINETY_DAYS_AGO = { dateId: "DAGO90" };
    this.NINETY_DAYS_FROM_NOW = { dateId: "DFN90" };
    this.ONE_YEAR_BEFORE_LAST = { dateId: "OYBL" };
    this.PREVIOUS_FISCAL_QUARTERS_LAST_FISCAL_YEAR = { dateId: "PQLFY" };
    this.PREVIOUS_FISCAL_QUARTERS_THIS_FISCAL_YEAR = { dateId: "PQTFY" };
    this.PREVIOUS_MONTHS_LAST_FISCAL_HALF = { dateId: "PMLFH" };
    this.PREVIOUS_MONTHS_LAST_FISCAL_QUARTER = { dateId: "PMLFQ" };
    this.PREVIOUS_MONTHS_LAST_FISCAL_YEAR = { dateId: "PMLFY" };
    this.PREVIOUS_MONTHS_SAME_FISCAL_HALF_LAST_FISCAL_YEAR = { dateId: "PMSFHLFY" };
    this.PREVIOUS_MONTHS_SAME_FISCAL_QUARTER_LAST_FISCAL_YEAR = { dateId: "PMSFQLFY" };
    this.PREVIOUS_MONTHS_THIS_FISCAL_HALF = { dateId: "PMTFH" };
    this.PREVIOUS_MONTHS_THIS_FISCAL_QUARTER = { dateId: "PMTFQ" };
    this.PREVIOUS_MONTHS_THIS_FISCAL_YEAR = { dateId: "PMTFY" };
    this.PREVIOUS_ONE_DAY = { dateId: "OD" };
    this.PREVIOUS_ONE_HALF = { dateId: "OH" };
    this.PREVIOUS_ONE_MONTH = { dateId: "OM" };
    this.PREVIOUS_ONE_QUARTER = { dateId: "OQ" };
    this.PREVIOUS_ONE_WEEK = { dateId: "OW" };
    this.PREVIOUS_ONE_YEAR = { dateId: "OY" };
    this.PREVIOUS_ROLLING_HALF = { dateId: "PRH" };
    this.PREVIOUS_ROLLING_QUARTER = { dateId: "PRQ" };
    this.PREVIOUS_ROLLING_YEAR = { dateId: "PRY" };
    this.SAME_DAY_FISCAL_QUARTER_BEFORE_LAST = { dateId: "SDFQBL" };
    this.SAME_DAY_FISCAL_YEAR_BEFORE_LAST = { dateId: "SDFYBL" };
    this.SAME_DAY_LAST_FISCAL_QUARTER = { dateId: "SDLFQ" };
    this.SAME_DAY_LAST_FISCAL_YEAR = { dateId: "SDLFY" };
    this.SAME_DAY_LAST_MONTH = { dateId: "SDLM" };
    this.SAME_DAY_LAST_WEEK = { dateId: "SDLW" };
    this.SAME_DAY_MONTH_BEFORE_LAST = { dateId: "SDMBL" };
    this.SAME_DAY_WEEK_BEFORE_LAST = { dateId: "SDWBL" };
    this.SAME_FISCAL_HALF_LAST_FISCAL_YEAR = { dateId: "SFHLFY" };
    this.SAME_FISCAL_HALF_LAST_FISCAL_YEAR_TO_DATE = { dateId: "SFHLFYTD" };
    this.SAME_FISCAL_QUARTER_FISCAL_YEAR_BEFORE_LAST = { dateId: "SFQFYBL" };
    this.SAME_FISCAL_QUARTER_LAST_FISCAL_YEAR = { dateId: "SFQLFY" };
    this.SAME_FISCAL_QUARTER_LAST_FISCAL_YEAR_TO_DATE = { dateId: "SFQLFYTD" };
    this.SAME_MONTH_FISCAL_QUARTER_BEFORE_LAST = { dateId: "SMFQBL" };
    this.SAME_MONTH_FISCAL_YEAR_BEFORE_LAST = { dateId: "SMFYBL" };
    this.SAME_MONTH_LAST_FISCAL_QUARTER = { dateId: "SMLFQ" };
    this.SAME_MONTH_LAST_FISCAL_QUARTER_TO_DATE = { dateId: "SMLFQTD" };
    this.SAME_MONTH_LAST_FISCAL_YEAR = { dateId: "SMLFY" };
    this.SAME_MONTH_LAST_FISCAL_YEAR_TO_DATE = { dateId: "SMLFYTD" };
    this.SAME_WEEK_FISCAL_YEAR_BEFORE_LAST = { dateId: "SWFYBL" };
    this.SAME_WEEK_LAST_FISCAL_YEAR = { dateId: "SWLFY" };
    this.SIXTY_DAYS_AGO = { dateId: "DAGO60" };
    this.SIXTY_DAYS_FROM_NOW = { dateId: "DFN60" };
    this.TEN_DAYS_AGO = { dateId: "DAGO10" };
    this.TEN_DAYS_FROM_NOW = { dateId: "DFN10" };
    this.THIRTY_DAYS_AGO = { dateId: "DAGO30" };
    this.THIRTY_DAYS_FROM_NOW = { dateId: "DFN30" };
    this.THIS_BUSINESS_WEEK = { dateId: "TBW" };
    this.THIS_FISCAL_HALF = { dateId: "TFH" };
    this.THIS_FISCAL_HALF_TO_DATE = { dateId: "TFHTD" };
    this.THIS_FISCAL_QUARTER = { dateId: "TFQ" };
    this.THIS_FISCAL_QUARTER_TO_DATE = { dateId: "TFQTD" };
    this.THIS_FISCAL_YEAR = { dateId: "TFY" };
    this.THIS_FISCAL_YEAR_TO_DATE = { dateId: "TFYTD" };
    this.THIS_MONTH = { dateId: "TM" };
    this.THIS_MONTH_TO_DATE = { dateId: "TMTD" };
    this.THIS_ROLLING_HALF = { dateId: "TRH" };
    this.THIS_ROLLING_QUARTER = { dateId: "TRQ" };
    this.THIS_ROLLING_YEAR = { dateId: "TRY" };
    this.THIS_WEEK = { dateId: "TW" };
    this.THIS_WEEK_TO_DATE = { dateId: "TWTD" };
    this.THIS_YEAR = { dateId: "TY" };
    this.THIS_YEAR_TO_DATE = { dateId: "TYTD" };
    this.THREE_DAYS_AGO = { dateId: "DAGO3" };
    this.THREE_DAYS_FROM_NOW = { dateId: "DFN3" };
    this.THREE_FISCAL_QUARTERS_AGO = { dateId: "FQB" };
    this.THREE_FISCAL_QUARTERS_AGO_TO_DATE = { dateId: "FQBTD" };
    this.THREE_FISCAL_YEARS_AGO = { dateId: "FYB" };
    this.THREE_FISCAL_YEARS_AGO_TO_DATE = { dateId: "FYBTD" };
    this.THREE_MONTHS_AGO = { dateId: "MB" };
    this.THREE_MONTHS_AGO_TO_DATE = { dateId: "MBTD" };
    this.TODAY = { dateId: "TODAY" };
    this.TODAY_TO_END_OF_THIS_MONTH = { dateId: "TODAYTTM" };
    this.TOMORROW = { dateId: "TOMORROW" };
    this.TWO_DAYS_AGO = { dateId: "DAGO2" };
    this.TWO_DAYS_FROM_NOW = { dateId: "DFN2" };
    this.WEEK_AFTER_NEXT = { dateId: "WAN" };
    this.WEEK_AFTER_NEXT_TO_DATE = { dateId: "WANTD" };
    this.WEEK_BEFORE_LAST = { dateId: "WBL" };
    this.WEEK_BEFORE_LAST_TO_DATE = { dateId: "WBLTD" };
    this.YESTERDAY = { dateId: "YESTERDAY" };
  }
