module.exports = (function () {
  ...
  function Type() {
    ...
    this.FIN_RPT_AGGREGATE_F_R = "finrptaggregatef_r";
    ...
    this.ROLE = "role";
    this.S_C_M_PREDICTED_RISKS = "sc_mpredictedrisks";
    this.S_C_M_PREDICTION_TRAIN_HISTORY = "sc_mpredictiontrainhistory";
