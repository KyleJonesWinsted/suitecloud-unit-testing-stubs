module.exports = (function () {
  ...
  function Type() {
    ...
    this.CAN_SELECT_ONLY_ONE_DEFAULT_CHOICE = "CAN_SELECT_ONLY_ONE_DEFAULT_CHOICE";
    ...
    this.CANNOT_RESUBMIT_SUBMITTED_ASYNC_PIVOT_TASK = "CANNOT_RESUBMIT_SUBMITTED_ASYNC_PIVOT_TASK";
    ...
    this.CREDIT_CARD_NUMBER_MUST_CONTAIN_BETWEEN_13_AND_20_DIGITS = "CREDIT_CARD_NUMBER_MUST_CONTAIN_BETWEEN_13_AND_20_DIGITS";
    this.DATASET_NAME_IS_MISSING = "DATASET_NAME_IS_MISSING";
    this.DEFAULT_CHOICE_IS_MISSING = "DEFAULT_CHOICE_IS_MISSING";
    ...
    this.EMPTY_KEY_NOT_ALLOWED_FOR_1 = "EMPTY_KEY_NOT_ALLOWED_FOR_1";
    this.EXPRESSION_CANNOT_BE_SPECIFIED_WHEN_USING_COUNT_DISTINCT_AGGREGATION = "EXPRESSION_CANNOT_BE_SPECIFIED_WHEN_USING_COUNT_DISTINCT_AGGREGATION";
    this.EXPRESSION_MUST_BE_SPECIFIED_WHEN_USING_OTHER_THAN_COUNT_DISTINCT_AGGREGATION = "EXPRESSION_MUST_BE_SPECIFIED_WHEN_USING_OTHER_THAN_COUNT_DISTINCT_AGGREGATION";
    this.EXPRESSIONS_CANNOT_BE_SPECIFIED_WHEN_USING_OTHER_THAN_COUNT_DISTINCT_AGGREGATION = "EXPRESSIONS_CANNOT_BE_SPECIFIED_WHEN_USING_OTHER_THAN_COUNT_DISTINCT_AGGREGATION";
    this.EXPRESSIONS_MUST_BE_SPECIFIED_WHEN_USING_COUNT_DISTINCT_AGGREGATION = "EXPRESSIONS_MUST_BE_SPECIFIED_WHEN_USING_COUNT_DISTINCT_AGGREGATION";
    ...
    this.INVALID_ALPHA_VALUE = "INVALID_ALPHA_VALUE";
    ...
    this.INVALID_COLOR_VALUE = "INVALID_COLOR_VALUE";
    this.INVALID_COLUMN_ALIAS = "INVALID_COLUMN_ALIAS";
    ...
    this.INVALID_CONFLICT_RESOLUTION_1 = "INVALID_CONFLICT_RESOLUTION_1";
    this.INVALID_CURRENCY = "INVALID_CURRENCY";
    ...
    this.INVALID_DATE_OBJECT = "INVALID_DATE_OBJECT";
    ...
    this.INVALID_FONT_SIZE = "INVALID_FONT_SIZE";
    this.INVALID_FONT_STYLE = "INVALID_FONT_STYLE";
    this.INVALID_FONT_WEIGHT = "INVALID_FONT_WEIGHT";
    this.INVALID_FORMULA_TYPE = "INVALID_FORMULA_TYPE";
    this.INVALID_GETSELECTOPTION_FILTER_OPERATOR = "INVALID_GETSELECTOPTION_FILTER_OPERATOR";
    this.INVALID_HTTP_METHOD = "INVALID_HTTP_METHOD";
    this.INVALID_ID_PREFIX = "INVALID_ID_PREFIX";
    this.INVALID_IMAGE = "INVALID_IMAGE";
    this.INVALID_KEY_OR_REF = "INVALID_KEY_OR_REF";
    ...
    this.INVALID_OWNER_CATEGORY = "INVALID_OWNER_CATEGORY";
    ...
    this.INVALID_POSITION = "INVALID_POSITION";
    this.INVALID_RCRD_TYPE = "INVALID_RCRD_TYPE";
    this.INVALID_RETURN_TYPE_EXPECTED_1 = "INVALID_RETURN_TYPE_EXPECTED_1";
    this.INVALID_SCRIPT_OPERATION_ON_READONLY_SUBLIST_FIELD = "INVALID_SCRIPT_OPERATION_ON_READONLY_SUBLIST_FIELD";
    ...
    this.INVALID_SUBLST_OPERATION = "INVALID_SUBLST_OPERATION";
    ...
    this.INVALID_TEPORAL_UNIT = "INVALID_TEPORAL_UNIT";
    this.INVALID_TEXT_ALIGN = "INVALID_TEXT_ALIGN";
    this.INVALID_TEXT_DECORATION_LINE = "INVALID_TEXT_DECORATION_LINE";
    this.INVALID_TEXT_DECORATION_STYLE = "INVALID_TEXT_DECORATION_STYLE";
    this.INVALID_TOTAL_LINE = "INVALID_TOTAL_LINE";
    this.INVALID_TYPE_1_USE_2 = "INVALID_TYPE_1_USE_2";
    this.INVALID_UI_OBJECT_TYPE = "INVALID_UI_OBJECT_TYPE";
    ...
    this.METHOD_IS_ONLY_ALLOWED_FOR_MATRIX_FIELD = "METHOD_IS_ONLY_ALLOWED_FOR_MATRIX_FIELD";
    this.MISSING_MANDATORY_FIELDS = "MISSING_MANDATORY_FIELDS";
    this.MISSING_REQD_ARGUMENT = "MISSING_REQD_ARGUMENT";
    ...
    this.NO_DATASET_DEFINED = "NO_DATASET_DEFINED";
    this.NO_DIMENSION_ITEM_DEFINED = "NO_DIMENSION_ITEM_DEFINED";
    this.NO_ELEMENTS_DEFINED = "NO_ELEMENTS_DEFINED";
    this.NO_MEASURES_DEFINED = "NO_MEASURES_DEFINED";
    this.NO_RULE_DEFINED = "NO_RULE_DEFINED";
    this.NO_SELECTORS_DEFINED = "NO_SELECTORS_DEFINED";
    ...
    this.PIVOT_DOES_NOT_EXIST = "PIVOT_DOES_NOT_EXIST";
    ...
    this.SERVER_SIDE_VALIDATION_FAILED = "SERVER_SIDE_VALIDATION_FAILED";
    ...
    this.UNSUPPORTED_COLOR = "UNSUPPORTED_COLOR";
    this.VALUE_1_OUTSIDE_OF_VALID_MINMAX_RANGE_FOR_FIELD2 = "VALUE_1_OUTSIDE_OF_VALID_MINMAX_RANGE_FOR_FIELD2";
